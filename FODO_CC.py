...
#tLat = [ENT.MQuad(5e-2,-8.2,"QD"), ENT.MQuad(5e-2,8.2,"QF")]

tLat = LTC.Lattice([ENT.MQuad(5e-2,-8.2,"QD"), ENT.MQuad(5e-2,8.2,"QF")], PCL.Particle(),'Vode')
StateList = form_state_list((1e-3,1e-3),(1e-3,1e-3),1,1)
...
dat = df.loc[df['variable'].isin(['x','y'])&df['PID'].isin(['X0'])]
